document.addEventListener('DOMContentLoaded', function() {
    ...
    var students = siteData.students || [];
    var student = null;
    ...
    function renderAchievement(student) {
        ...
        var achievementHtml = '<div class="space-y-5"><div><h3 class="font-display font-semibold text-lg" style="color:#0b1b33">Achievement Title</h3><p class="mt-3 text-sm leading-relaxed whitespace-pre-line" style="color:#5b6478">' + formatMultiline(achievement) + '</p></div>';
        if (description) {
            achievementHtml += '<div style="border-top:1px solid #e2e8f0" class="pt-5"><h3 class="font-display font-semibold text-sm" style="color:#0b1b33">Description</h3><p class="mt-2 text-sm leading-relaxed" style="color:#5b6478">' + escapeHtml(description) + '</p></div>';
        }
        achievementHtml += '</div>';
